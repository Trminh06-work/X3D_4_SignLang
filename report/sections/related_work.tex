...
\paragraph{MViT \cite{fan2021mvit,li2022mvitv2}.} This model was established by leveraging the \textit{multiscale feature hierarchies} in CNN–based models and the \textit{attention} mechansim in Transformer–based models.
