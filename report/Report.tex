...
\begin{abstract}
    ...
    The ``best'' configuration, in terms of accuracy–trainable parameters trade–off, \texttt{X3D\_M} with two frozen blocks, reaches $82.28\%$ top--1 on the test split at $4.90$ GFLOPs per clip.
